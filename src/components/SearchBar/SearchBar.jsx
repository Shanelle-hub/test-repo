...
function SearchBar({value,onChange,onClearSearch,handleSearch}) {
  return (
    <div className='w-80 flex items-start px-4 py-2 bg-slate-100 rounded-md'>
        
        <input type="text"
        placeholder='Search Notes '
        className='w-full text-xs  bg-transparent py-[11] outline-none'
        value={value}
        onChange={onChange} />
        {value &&
